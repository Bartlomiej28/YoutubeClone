<template>
    <div class="w-full min-h-screen h-auto flex flex-col p-4">
        <div class="w-full flex flex-row gap-4">
            <div>
                <img :src="channelThumbnail" class="w-64 h-64 rounded-full object-cover object-center"/>
            </div>
            <div class="flex flex-col gap-2 w-1/3">
                <p class="font-bold text-5xl">{{channelData.title}}</p>
                ...
                <button class="px-4 py-2 text-white bg-black w-min h-min rounded-full">Subskrybuj</button>
            </div>
        </div>
